...
export function makeSchedulePreview(schedule, limit = 4) {
...
export function makeRepaymentSummary(scenario, plan, monthlyIncome = 0, processingFeePct = 0) {
...
export function makeLearningCards() {
    return [
        {
